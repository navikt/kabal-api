...
class LayeredArchitectureTest {
    ...
    private fun kabalApiLayeredArchitecture(): Architectures.LayeredArchitecture = layeredArchitecture().consideringAllDependencies()
        .layer("Controllers").definedBy("no.nav.klage.oppgave.api.controller..", "no.nav.klage.dokument.api.controller..", "no.nav.klage.innsyn.api.controller..", "no.nav.klage.kaptein.api.controller..")
        .layer("ApiMappers").definedBy("no.nav.klage.oppgave.api.mapper..", "no.nav.klage.dokument.api.mapper..")
        .layer("View").definedBy("no.nav.klage.oppgave.api.view..", "no.nav.klage.dokument.api.view..", "no.nav.klage.innsyn.api.view..", "no.nav.klage.kaptein.api.view..")
        .layer("Services").definedBy("no.nav.klage.oppgave.service..", "no.nav.klage.dokument.service..", "no.nav.klage.innsyn.service..", "no.nav.klage.kaptein.service..")
    ...
    val layer_dependencies_are_respected_for_eventlisteners: ArchRule = kabalApiLayeredArchitecture()
        .whereLayer("Eventlisteners").mayOnlyBeAccessedByLayers("Config", "Services", "Domain")
