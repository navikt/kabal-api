...
class TokenUtil(
    ...
    fun getAppAccessTokenWithSkjermedePersonerPipScope(): String {
        val clientProperties = clientConfigurationProperties.registration["skjermede-personer-pip-maskintilmaskin"]!!
        val response = oAuth2AccessTokenService.getAccessToken(clientProperties)
        return response.access_token!!
    }
