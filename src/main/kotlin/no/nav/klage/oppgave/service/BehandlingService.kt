...
import no.nav.klage.oppgave.domain.behandling.setters.BehandlingSetters.removeSaksdokumenter
...
import no.nav.klage.oppgave.domain.behandling.setters.BehandlingSetters.setGosysOppgaveUpdate
import no.nav.klage.oppgave.domain.behandling.setters.BehandlingSetters.setIgnoreGosysOppgave
import no.nav.klage.oppgave.domain.behandling.setters.BehandlingSetters.setInnsendingshjemler
import no.nav.klage.oppgave.domain.behandling.setters.BehandlingSetters.setKlager
...
import no.nav.klage.oppgave.domain.behandling.setters.BehandlingSetters.setRegistreringshjemler
import no.nav.klage.oppgave.domain.behandling.setters.BehandlingSetters.setSattPaaVent
import no.nav.klage.oppgave.domain.behandling.setters.BehandlingSetters.setTilbakekreving
...
class BehandlingService(
    ...
    fun validateBehandlingBeforeFinalize(behandlingId: UUID, nyBehandlingEtterTROpphevet: Boolean) {
        ...
        if (behandling.gosysOppgaveRequired && behandling.gosysOppgaveId == null) {
            behandlingValidationErrors.add(
                InvalidProperty(
                    field = "gosysOppgave",
