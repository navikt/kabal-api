...
class KabinApiService(
    ...
    private fun getCreatedAnkebehandlingStatusForKabin(
        ...
        return CreatedAnkebehandlingStatusForKabin(
            ...
            klager = behandlingMapper.getPartView(ankebehandling.klager.partId),
            fullmektig = ankebehandling.klager.prosessfullmektig?.let { behandlingMapper.getPartView(it.partId) },
    ...
    private fun getCreatedKlagebehandlingStatusForKabin(
        ...
        return CreatedKlagebehandlingStatusForKabin(
            ...
            klager = behandlingMapper.getPartView(klagebehandling.klager.partId),
            fullmektig = klagebehandling.klager.prosessfullmektig?.let { behandlingMapper.getPartView(it.partId) },
