...
enum class BehandlingState {
    MOTTATT, TILDELT_SAKSBEHANDLER, AVSLUTTET, UKJENT, SENDT_TIL_TR, AVSLUTTET_I_TR_OG_NY_ANKEBEHANDLING_I_KA, NY_ANKEBEHANDLING_I_KA_UTEN_TR, AVSLUTTET_I_TR_MED_OPPHEVET_OG_NY_BEHANDLING_I_KA, OPPRETTET,
