...
data class BehandlingChangedEvent(
        ...
        companion object {
            ...
            fun createChange(
                ...
                if ((fraVerdi == null && tilVerdi == null) || fraVerdi == tilVerdi) {
                    logger.debug(
                        "Returning null from createChange. Felt: {}, fraVerdi: {}, tilVerdi: {}, behandlingId: {}",
                        felt.name,
                        fraVerdi,
                        tilVerdi,
                        behandlingId
    ...
    enum class Felt {
        ...
        TILBAKEKREVING,
        GOSYSOPPGAVE_ID,
        BEGJAERING_OM_GJENOPPTAKSBEHANDLING_MOTTATT,
        BEGJAERING_OM_GJENOPPTAKSBEHANDLING_OPPRETTET,
        BEGJAERING_OM_GJENOPPTAK_I_TRYGDERETTEN_OPPRETTET,
        BEGJAERING_OM_GJENOPPTAKSBEHANDLING_OPPRETTET_BASERT_PAA_BEGJAERING_OM_GJENOPPTAK_I_TRYGDERETTEN,
        PERSON_PROTECTION_CHANGED,
        PAAANKET_VEDTAKSDATO,
        FORSTERKET_RETT,
    }
}