...
class SmartEditorController(
    ...
    fun patchDocument(
        ...
        smartDocumentService.patchSmartDocument(
            behandlingId = behandlingId,
    ...
    fun getDocument(
        ...
        smartDocumentService.getSmartDocument(
            behandlingId = behandlingId,
    ...
    fun getDocumentVersion(
        ...
        smartDocumentService.getSmartDocumentVersion(
            documentId = documentId,
            version = version,
        )
    ...
    fun findSmartDocumentVersions(
        ...
        smartDocumentService.findSmartDocumentVersions(
            behandlingId = behandlingId,
            documentId = documentId,
        )
    ...
    fun createComment(
        ...
        smartDocumentService.createComment(
            documentId = documentId,
    ...
    fun modifyComment(
        ...
        smartDocumentService.modifyComment(
            documentId = documentId,
            commentId = commentId,
    ...
    fun getAllCommentsWithPossibleThreads(
        ...
        smartDocumentService.getAllCommentsWithPossibleThreads(
            documentId = documentId,
        )
    ...
    fun replyToComment(
        ...
        smartDocumentService.replyToComment(
            documentId = documentId,
            commentId = commentId,
            commentInput = commentInput,
        )
    ...
    fun getCommentWithPossibleThread(
        ...
        smartDocumentService.getCommentWithPossibleThreads(
            documentId = documentId,
            commentId = commentId,
        )
