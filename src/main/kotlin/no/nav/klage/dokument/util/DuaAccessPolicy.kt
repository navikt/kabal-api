...
class DuaAccessPolicy {
    ...
    companion object {
        ...
        fun initializeAccessMapFromCsv(resourcePath: String = "/dua/access_map.csv") {
            ...
            val inputStream =
                DuaAccessPolicy::class.java.getResourceAsStream(resourcePath)
        ...
        fun throwDuaFinishedException(): Unit = throw RuntimeException("Ferdigstilt dokument kan ikke endres. Kontakt Team Klage.")

        fun throwFeilregistrertException(): Unit = throw RuntimeException("Behandlingen er feilregistrert.")
        ...
        fun validateDuaAccess(
            ...
            when (access) {
                ...
                // should not happen, as it is handled above
        ...
        private val errorMessageMap =
            hashMapOf(
                ...
                "NOT_ASSIGNED_OR_MU:CHANGE_TYPE" to
