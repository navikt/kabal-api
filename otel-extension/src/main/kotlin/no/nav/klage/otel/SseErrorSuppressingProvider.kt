...
/**
 * OTEL Java agent extension that suppresses spurious ERROR statuses on SSE
 * endpoint span(s) caused by clients disconnecting.
 *
...
internal class SseErrorSuppressingSpanExporter(
    ...
    private fun isSseSpan(sd: SpanData): Boolean {
        ...
        // Fallback: the agent may use the route as the span name (e.g. "GET /behandlinger/{behandlingId}/events").
    ...
    private companion object {
        ...
        // Path of the SSE endpoint defined in EventController.
